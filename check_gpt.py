...
def get_header_hash():
	header = data[512:512+arr2num(data[512 + 0xc:512 + 0xc + 4])]
	header[0x10 + 0] = 0
	header[0x10 + 1] = 0
	header[0x10 + 2] = 0
	header[0x10 + 3] = 0
...
def get_partion_hash():
	table = data[1024:1024+128*arr2num(data[512 + 0x50:512 + 0x50 + 4])]
...
print("GPT LBA:                    ", arr2num(data[512 + 0x18:512 + 0x18 + 8]))
print("Alternate GPT LBA:          ", arr2num(data[512 + 0x20:512 + 0x20 + 8]))

print("table LBA:                  ", arr2num(data[512 + 0x48:512 + 0x48 + 8]))

print("Start usable LBA:           ", arr2num(data[512 + 0x28:512 + 0x28 + 8]))
print("End usable LBA:             ", arr2num(data[512 + 0x30:512 + 0x30 + 8]))

print("GUID:                       ", hex(arr2num(data[512 + 0x38:512 + 0x38 + 16])))

print("LBA partion entry:          ", arr2num(data[512 + 0x48:512 + 0x48 + 8]))
